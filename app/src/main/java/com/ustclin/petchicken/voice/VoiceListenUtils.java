 ...
 * description
 */
public class VoiceListenUtils {
    private static String TAG = VoiceListenUtils.class.getSimpleName();
    // 语音听写对象
...
//    private SharedPreferences mSharedPreferences;
    ...
    public VoiceListenUtils(Context context) {
        mContext = context;
        // 初始化识别无UI识别对象
...
//        }
    ...
    private RecognizerListener mRecognizerListener = new RecognizerListener() {
        ...
        public void onResult(RecognizerResult results, boolean isLast) {
            ...
            if (isLast) {
                // TODO 最后的结果
                Log.d(TAG, "This is the Last One");
            }
        }
